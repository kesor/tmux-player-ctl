...
class TestEnableRawMode(unittest.TestCase):
    ...
    def test_enable_raw_mode_returns_settings_when_tty(self, mock_setattr, mock_getattr, mock_isatty):
...
class TestReadMetadataFromFollower(unittest.TestCase):
    ...
    def test_parses_valid_prefixed_metadata(self):
        ...
        fields = {}
        defaults = {
            "volume": "0.0", "explicit": "false", "loopStatus": "None",
