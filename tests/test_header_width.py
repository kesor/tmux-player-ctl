...
class TestHeaderRowWidth(unittest.TestCase):
    ...
    def test_pad_visible_produces_correct_width(self):
        ...
        self.assertEqual(tpc.visible_width(result), 10, f"pad_visible to width 10: {repr(result)}")
    ...
    def test_pad_visible_cjk_wide_characters(self):
        ...
        self.assertEqual(tpc.visible_width(result), 45, f"pad_visible with CJK to width 45: {repr(result)}")
